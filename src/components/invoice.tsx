      ...
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-2xl">
        <div ref={printRef} className="p-8 bg-white border border-gray-200">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="text-right">
              <h2 className="font-semibold">Boss Company</h2>
          ...
          <table className="w-full mb-6 border-collapse">
            ...
            <tbody>
              <tr>
                <td className="border p-2">Web Implementation</td>
                <td className="border p-2 text-right">1</td>
                <td className="border p-2 text-right">$1,500.00</td>
                <td className="border p-2 text-right">$1,500.00</td>
              </tr>
              <tr>
                <td className="border p-2">Hosting Services</td>
                <td className="border p-2 text-right">1</td>
        ...
        <div className="mt-6 flex justify-center">
          <button
            ...
            className="flex items-center bg-green-600 text-white px-4 py-2 rounded hover:bg-green-400 transition duration-300"
          >
            Download PDF
          </button>
        </div>
